...
object Compiler extends Errors {
  def main(args: Array[String]): Unit = {
    ...
    if (args.length == 0) {
      ...
      lazy val linux    = (args contains "--linux")
